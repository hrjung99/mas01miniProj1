...
<body>
	...
	<div style = "background-color:#98D7A5;">
		<a href="/miniProj1/jsp/member/MemberInsertForm.jsp">회원가입</a>
		<a href="/miniProj1/jsp/member/MemberList.jsp">회원관리</a> 
		<a href="/miniProj1/jsp/member/MemberView.jsp">마이페이지</a> 
	...
	<div style = "background-color:#8DC77B;">
		...
		<a href="/miniProj1/jsp/board/Boar	dList.jsp">커뮤니티</a>
	</div>
